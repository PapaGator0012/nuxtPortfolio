                      ...
                      <div class="postbox__main-wrapper">
                        ...
                        <div class="postbox__details-content-wrapper">
                          ...
                          <div class="postbox__img m-img mt-50 mb-45">
                            <img src="assets/images/blog/blog1.jpeg" alt="" />
                              ...
                              <div class="row">
                                ...
                                <div class="col-xxl-12">
                                  <div class="postbox__comment-agree d-flex align-items-start mb-25">
                                    ...
                                    <label class="e-check-label" htmlFor="e-agree">Save my name, email, and website in this browser for the next time I comment.</label>
                                  </div>
                                </div>
                                <div class="col-xxl-12">
                                  <div class="postbox__comment-btn">
                                    <button type="submit" class="theme-btn theme-btn-two">Submit Comment</button>
                                  </div>
                                </div>
                              </div>
                            </form>
                    ...
                    <div class="col-xxl-4 col-lg-4">
                      <div class="blog_sidebar__wrapper pl-40">
                        ...
                        <div class="sidebar__widget mb-45">
                          ...
                          <div class="sidebar__widget-content">
                            <ul>
                              <li><NuxtLink to="/blog">Design Media <span>10</span></NuxtLink></li>
                              <li><NuxtLink to="/blog">Figma Design <span>08</span></NuxtLink></li>
                              <li><NuxtLink to="/blog">Web Design <span>24</span></NuxtLink></li>
                              <li><NuxtLink to="/blog">Wix Development <span>37</span></NuxtLink></li>
